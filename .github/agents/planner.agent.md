...
4. When producing a task spec, explicitly state testing and teaching-artifact requirements (which unit/integration tests the `@engineer` must add, and whether teaching artifacts in learning-artifacts.md are required).
